...
# 训练超参数
EPOCHS = 50
BATCH_SIZE = 580 # Transformer usually takes more memory, maybe lower batch size
...
train_full_ds = SCSNDataset(TRAIN_H5, preload=PRELOAD_RAM, split="train", allowed_labels=ALLOWED_LABELS)
test_ds = SCSNDataset(TEST_H5, preload=PRELOAD_RAM, split="test", allowed_labels=ALLOWED_LABELS)
...
config = TrainingConfig(
    ...
    patience=5,
    resume_checkpoint="./checkpoints_eqpolarity_scsn/scsn_best.pth"  # 可选：从检查点恢复训练,
)

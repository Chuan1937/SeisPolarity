# Configuration shared by the English and Chinese documentation builds.
# Each language directory (en/, zh_CN/) has a thin conf.py that imports this
# module and overrides ``language``.
...
templates_path = [str(repository_root / "docs" / "_templates")]
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store"]

add_module_names = False

html_theme = "sphinx_rtd_theme"
html_static_path = [str(repository_root / "docs" / "_static")]
html_logo = str(repository_root / "docs" / "_static" / "seispolarity_logo.svg")
html_favicon = str(repository_root / "docs" / "_static" / "seispolarity_logo.svg")
...
def setup(app):
    ...
    def html_page_context_handler(app, pagename, templatename, context, doctree):
        context["doc_language"] = app.config.language

...
class STFTDenoiserLabeller:
    ...
    :param noise_dataset: SeisPolarity WaveformDataset that only contains noise waveforms for training.
    ...
    def __init__(
        self,
        noise_dataset: seispolarity.data.base.WaveformDataset,
        ...
        **kwargs,
        ...
        self.noise_generator = seispolarity.generate.GenericGenerator(noise_dataset)
